...
public class AppRunner {
    ...
    CommandLineRunner loadData() {
        return args -> {
            Address address = new Address("Serbia", "Belgrade",  "11000", "Knez Mihailova", "6/6", 40.5, -10.3, false, null);
            ...
            Address address2 = new Address("Serbia", "Belgrade",  "11000", "Knez Mihailova", "6/5", 40.5, -10.3, true, null);
