...
public class AppRunner {
    ...
    CommandLineRunner loadData() {
        return args -> {
            ...
            Category category = new Category("Poklon", "Present", "Odaberite poklon za vase najdraze");
            category = categoryRepository.save(category);

            Category category1 = new Category("Turizam", "Travel", "Upoznajte se sa znamenitostima");
            ...
            business2.setId(UUID.fromString("37ca6872-1d7b-48f8-897d-21b264acdef9"));
